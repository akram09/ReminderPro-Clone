...
public class getAllTasksUseCase extends BaseUseCase<List<Task>,Void > {
    private TasksDataSource dataSource ;

    @Inject
    public getAllTasksUseCase(PostExecuteThread postExecuteThread, ThreadExecutor threadExecutor, TasksDataSource dataSource) {
