...
public class getActiveTaskUseCase extends BaseUseCase<List<Task>, Void> {

    private TasksDataSource dataSource ;
    @Inject
    public getActiveTaskUseCase(PostExecuteThread postExecuteThread, ThreadExecutor threadExecutor, TasksDataSource dataSource) {
